...
export default async function Run(trx) {
    ...
    return "Dropped 'license_image' column from table 'users'. Renamed 'data_hash' to 'integriy', added unique constaint, and increased maximum size of 'data' column in 'images' table.";
}
